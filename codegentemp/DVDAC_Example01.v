// ======================================================================
// DVDAC_Example01.v generated from TopDesign.cysch
// 05/15/2019 at 17:02
...
// ADC_DelSig_v3_20(ADC_Alignment=0, ADC_Alignment_Config2=0, ADC_Alignment_Config3=0, ADC_Alignment_Config4=0, ADC_Charge_Pump_Clock=true, ADC_Clock=1, ADC_CLOCK_FREQUENCY=1899984, ADC_Input_Mode=1, ADC_Input_Range=3, ADC_Input_Range_Config2=2, ADC_Input_Range_Config3=0, ADC_Input_Range_Config4=0, ADC_Power=1, ADC_Reference=0, ADC_Reference_Config2=5, ADC_Reference_Config3=0, ADC_Reference_Config4=0, ADC_Resolution=10, ADC_Resolution_Config2=16, ADC_Resolution_Config3=16, ADC_Resolution_Config4=16, Clock_Frequency=64000, Comment_Config1=6.144 volt range, Comment_Config2=4 V Range, Comment_Config3=Third Config, Comment_Config4=Fourth Config, Config1_Name=CFG1, Config2_Name=CFG2, Config3_Name=CFG3, Config4_Name=CFG4, Configs=1, Conversion_Mode=2, Conversion_Mode_Config2=2, Conversion_Mode_Config3=2, Conversion_Mode_Config4=2, Enable_Vref_Vss=false, EnableModulatorInput=false, Input_Buffer_Gain=1, Input_Buffer_Gain_Config2=1, Input_Buffer_Gain_Config3=1, Input_Buffer_Gain_Config4=1, Input_Buffer_Mode=1, Input_Buffer_Mode_Config2=1, Input_Buffer_Mode_Config3=1, Input_Buffer_Mode_Config4=1, Ref_Voltage=1.024, Ref_Voltage_Config2=1.25, Ref_Voltage_Config3=1.024, Ref_Voltage_Config4=1.024, rm_int=false, Sample_Rate=82608, Sample_Rate_Config2=10000, Sample_Rate_Config3=10000, Sample_Rate_Config4=10000, Start_of_Conversion=0, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_DelSig_v3_20, CY_CONFIG_TITLE=ADC_DelSig, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_DelSig, CY_INSTANCE_SHORT_NAME=ADC_DelSig, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_DelSig, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=128, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=ms_counter, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ms_counter, CY_INSTANCE_SHORT_NAME=ms_counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ms_counter, )
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=17999996, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=1285714, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=Num_Notes_Selector_ADC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Num_Notes_Selector_ADC, CY_INSTANCE_SHORT_NAME=Num_Notes_Selector_ADC, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Num_Notes_Selector_ADC, )
...
module top ;
	...
	wire [0:0] tmpOE__ADC_IN_6V_net;
	wire [0:0] tmpFB_0__ADC_IN_6V_net;
	wire [0:0] tmpIO_0__ADC_IN_6V_net;
	wire [0:0] tmpINTERRUPT_0__ADC_IN_6V_net;
	electrical [0:0] tmpSIOVREF__ADC_IN_6V_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("2c60c5bf-f667-4ca3-89eb-9dbe994754a3"),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_IN_6V
		 (.oe(tmpOE__ADC_IN_6V_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_IN_6V_net[0:0]}),
		  .analog({Net_279}),
		  .io({tmpIO_0__ADC_IN_6V_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_IN_6V_net),
		  .interrupt({tmpINTERRUPT_0__ADC_IN_6V_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_IN_6V_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__TC_1_net;
	wire [0:0] tmpFB_0__TC_1_net;
	wire [0:0] tmpIO_0__TC_1_net;
	wire [0:0] tmpINTERRUPT_0__TC_1_net;
	electrical [0:0] tmpSIOVREF__TC_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		TC_1
		 (.oe(tmpOE__TC_1_net),
		  .y({Net_525}),
		  .fb({tmpFB_0__TC_1_net[0:0]}),
		  .io({tmpIO_0__TC_1_net[0:0]}),
		  .siovref(tmpSIOVREF__TC_1_net),
		  .interrupt({tmpINTERRUPT_0__TC_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TC_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__MUX_D_net;
	wire [0:0] tmpFB_0__MUX_D_net;
	wire [0:0] tmpIO_0__MUX_D_net;
	wire [0:0] tmpINTERRUPT_0__MUX_D_net;
	electrical [0:0] tmpSIOVREF__MUX_D_net;
	...
	cy_psoc3_pins_v1_10
		...
		MUX_D
		 (.oe(tmpOE__MUX_D_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MUX_D_net[0:0]}),
		  .io({tmpIO_0__MUX_D_net[0:0]}),
		  .siovref(tmpSIOVREF__MUX_D_net),
		  .interrupt({tmpINTERRUPT_0__MUX_D_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MUX_D_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MUX_INHIBIT_net;
	wire [0:0] tmpFB_0__MUX_INHIBIT_net;
	wire [0:0] tmpIO_0__MUX_INHIBIT_net;
	wire [0:0] tmpINTERRUPT_0__MUX_INHIBIT_net;
	electrical [0:0] tmpSIOVREF__MUX_INHIBIT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d34a2f3d-624d-4b27-afd8-66a5265e24f5"),
		  ...
		  .input_buffer_sel(2'b00))
		MUX_INHIBIT
		 (.oe(tmpOE__MUX_INHIBIT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MUX_INHIBIT_net[0:0]}),
		  .io({tmpIO_0__MUX_INHIBIT_net[0:0]}),
		  .siovref(tmpSIOVREF__MUX_INHIBIT_net),
		  .interrupt({tmpINTERRUPT_0__MUX_INHIBIT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MUX_INHIBIT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Counter_v3_0_5 ms_counter (
        ...
        .up_ndown(1'b1),
        .count(Net_671));
    defparam ms_counter.CaptureMode = 0;
    defparam ms_counter.ClockMode = 0;
    defparam ms_counter.CompareMode = 0;
    defparam ms_counter.CompareStatusEdgeSense = 1;
    defparam ms_counter.EnableMode = 0;
    defparam ms_counter.ReloadOnCapture = 0;
    defparam ms_counter.ReloadOnCompare = 0;
    defparam ms_counter.ReloadOnOverUnder = 1;
    defparam ms_counter.ReloadOnReset = 1;
    defparam ms_counter.Resolution = 32;
    defparam ms_counter.RunMode = 0;
    defparam ms_counter.UseInterrupt = 1;
    ...
    ADC_SAR_v3_10_6 Num_Notes_Selector_ADC (
        .vplus(Net_707),
        .vminus(Net_805),
        .soc(1'b0),
        .eoc(Net_807),
	...
	wire [0:0] tmpOE__Button5_net;
	wire [0:0] tmpFB_0__Button5_net;
	wire [0:0] tmpIO_0__Button5_net;
	wire [0:0] tmpINTERRUPT_0__Button5_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("052b878c-453f-45fe-8240-b6e6d650ec8d"),
		  ...
		  .input_buffer_sel(2'b00))
		Button5
		 (.oe(tmpOE__Button5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button5_net[0:0]}),
		  .io({tmpIO_0__Button5_net[0:0]}),
		  .siovref(tmpSIOVREF__Button5_net),
		  .interrupt({tmpINTERRUPT_0__Button5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SPI_Master_v2_50_7 SPI_OLED (
        .mosi(Net_1330),
        .sclk(Net_1362),
        .ss(Net_1609),
        .miso(1'b0),
        .clock(1'b0),
        .reset(1'b0),
        .rx_interrupt(Net_1335),
        .sdat(Net_1562),
        .tx_interrupt(Net_1336));
    defparam SPI_OLED.BidirectMode = 1;
	...
	wire [0:0] tmpOE__OLED_CS_net;
	wire [0:0] tmpFB_0__OLED_CS_net;
	wire [0:0] tmpIO_0__OLED_CS_net;
	wire [0:0] tmpINTERRUPT_0__OLED_CS_net;
	electrical [0:0] tmpSIOVREF__OLED_CS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("71ca2342-5b03-4985-a50a-6cf637eba900"),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_CS
		 (.oe(tmpOE__OLED_CS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OLED_CS_net[0:0]}),
		  .io({tmpIO_0__OLED_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__OLED_CS_net),
		  .interrupt({tmpINTERRUPT_0__OLED_CS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OLED_RES_net;
	wire [0:0] tmpFB_0__OLED_RES_net;
	wire [0:0] tmpIO_0__OLED_RES_net;
	wire [0:0] tmpINTERRUPT_0__OLED_RES_net;
	electrical [0:0] tmpSIOVREF__OLED_RES_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d4e38629-c5a7-4a56-9e0f-6239ba3f06a9"),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_RES
		 (.oe(tmpOE__OLED_RES_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OLED_RES_net[0:0]}),
		  .io({tmpIO_0__OLED_RES_net[0:0]}),
		  .siovref(tmpSIOVREF__OLED_RES_net),
		  .interrupt({tmpINTERRUPT_0__OLED_RES_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_RES_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OLED_SCK_net;
	wire [0:0] tmpFB_0__OLED_SCK_net;
	wire [0:0] tmpIO_0__OLED_SCK_net;
	wire [0:0] tmpINTERRUPT_0__OLED_SCK_net;
	electrical [0:0] tmpSIOVREF__OLED_SCK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("83b2fde2-60ad-45b6-9e5c-cb3baa6e3f9a"),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_SCK
		 (.oe(tmpOE__OLED_SCK_net),
		  .y({Net_1362}),
		  .fb({tmpFB_0__OLED_SCK_net[0:0]}),
		  .io({tmpIO_0__OLED_SCK_net[0:0]}),
		  .siovref(tmpSIOVREF__OLED_SCK_net),
		  .interrupt({tmpINTERRUPT_0__OLED_SCK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_SCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OLED_SDA_net;
	wire [0:0] tmpFB_0__OLED_SDA_net;
	wire [0:0] tmpINTERRUPT_0__OLED_SDA_net;
	electrical [0:0] tmpSIOVREF__OLED_SDA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		OLED_SDA
		 (.oe(tmpOE__OLED_SDA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OLED_SDA_net[0:0]}),
		  .io({Net_1562}),
		  .siovref(tmpSIOVREF__OLED_SDA_net),
		  .interrupt({tmpINTERRUPT_0__OLED_SDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OLED_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Counter_v3_0_8 game_random_mode_generator (
        .reset(1'b0),
        .tc(Net_1617),
        .comp(Net_1618),
        .clock(Net_1619),
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam game_random_mode_generator.CaptureMode = 0;
    defparam game_random_mode_generator.ClockMode = 0;
    defparam game_random_mode_generator.CompareMode = 1;
    defparam game_random_mode_generator.CompareStatusEdgeSense = 1;
    defparam game_random_mode_generator.EnableMode = 0;
    defparam game_random_mode_generator.ReloadOnCapture = 0;
    defparam game_random_mode_generator.ReloadOnCompare = 0;
    defparam game_random_mode_generator.ReloadOnOverUnder = 1;
    defparam game_random_mode_generator.ReloadOnReset = 1;
    defparam game_random_mode_generator.Resolution = 16;
    defparam game_random_mode_generator.RunMode = 0;
    defparam game_random_mode_generator.UseInterrupt = 1;
