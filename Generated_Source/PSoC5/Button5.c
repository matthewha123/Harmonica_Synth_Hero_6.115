...
*
* \funcusage
*  \snippet Button5_SUT.c usage_Button5_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Button5_SUT.c usage_Button5_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Button5_SUT.c usage_Button5_Read  
*******************************************************************************/
...
* preferred Button5_Read() API because the 
* Button5_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Button5_SUT.c usage_Button5_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Button5_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Button5_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Button5_0_INTR       (First pin in the list)
    *  - Button5_1_INTR       (Second pin in the list)
    *  - ...
    *  - Button5_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Button5_SUT.c usage_Button5_SetInterruptMode
    *******************************************************************************/
    void Button5_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Button5_0_INTR) != 0u) 
		{ 
			 Button5_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Button5_SUT.c usage_Button5_ClearInterrupt
    *******************************************************************************/
