...
{
    uint8 staticBits = (OLED_DC_DR & (uint8)(~OLED_DC_MASK));
    OLED_DC_DR = staticBits | ((uint8)(value << OLED_DC_SHIFT) & OLED_DC_MASK);
}
...
{
	CyPins_SetPinDriveMode(OLED_DC_0, mode);
}
...
{
    return (OLED_DC_PS & OLED_DC_MASK) >> OLED_DC_SHIFT;
}
...
{
    return (OLED_DC_DR & OLED_DC_MASK) >> OLED_DC_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(OLED_DC_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & OLED_DC_0_INTR) != 0u) 
		{ 
			 OLED_DC_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (OLED_DC_INTSTAT & OLED_DC_MASK) >> OLED_DC_SHIFT;
    }
